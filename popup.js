chrome.tabs.query({
    ...
    if(zoom && coord && coord.length == 2){
        ...
        document.getElementById("here").href='http://here.com/'+coord[1]+','+coord[0]+','+zoom+',0,0,hybrid.day';
        document.getElementById("here_map").href='http://here.com/'+coord[1]+','+coord[0]+','+zoom+',0,0,normal.day';
